        ...
        <Wrapper>
            <div className="text-center lg:grid lg:grid-cols-7 lg:grid-rows-3 items-center xl:mt-10">
                ...
                <div className="col-start-1 col-span-4 row-start-1 row-span-3 md:text-left mb-8">
                    <p className="text-center lg:text-left text-5xl mb-4 font-bold sm:text-6xl lg:text-7xl xl:text-8xl lg:mb-10 dark:text-zinc-100 apolline">Aiste Prusove</p>
                    <p className="text-center lg:text-left text-2xl md:text-3xl lg:text-4xl xl:text-6xl dark:text-zinc-100 apolline">&lt;code&gt; &amp;&amp; &#10000;design&#9998;</p>
                </div>
            </div>
        </Wrapper>
    )
